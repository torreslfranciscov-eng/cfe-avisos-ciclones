...
import { S3RequestOptions, S3UploadOptions, S3GetOptions, S3PresignedUploadOptions } from './types';
/**
...
export declare class PicoS3 {
    ...
    getObjectBuffer(options: S3GetOptions): Promise<Buffer<ArrayBufferLike>>;
    ...
    getPresignedUploadUrl(options: Omit<S3PresignedUploadOptions, keyof S3RequestOptions> & Partial<S3RequestOptions>): Promise<string>;
}
