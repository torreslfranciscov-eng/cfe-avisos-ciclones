...
exports.getObjectEtag = exports.objectExists = exports.getObjectMetadata = exports.deleteObject = exports.getPresignedUploadUrl = exports.getPresignedUrl = exports.getObject = exports.getObjectDataUrl = exports.getObjectBuffer = exports.getTextFile = exports.getObjectBinary = exports.upload = exports.uploadBuffer = exports.s3Request = exports.getS3RequestObject = exports.getProviderConfig = exports.getFileKey = exports.getCloudUrl = exports.FileNotFoundError = void 0;
...
const getFileKey = (options) => providers_1.PROVIDERS[options.provider].key && providers_1.PROVIDERS[options.provider].key(options).replace("//", "/");
...
const uploadBuffer = (options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const path = (0, exports.getFileKey)(options) || `/${(0, utils_1.resolvePath)(options)}`;
...
const getPresignedUploadUrl = (options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (options.public) {
            urlOptions.headers = Object.assign(Object.assign({}, (urlOptions.headers || {})), { 'x-amz-acl': 'public-read' });
        }
        // Sign the request
        const signedRequest = aws4_1.default.sign(urlOptions, {
            accessKeyId,
            secretAccessKey
        });
