...
class PicoS3 {
    ...
    constructor(options) {
        ...
        if (typeof options === "boolean" && options === true) {
            this.options = {
                ...
                region: process.env.PICO_S3_REGION,
                bucket: process.env.PICO_S3_BUCKET,
                host: (_a = process.env.PICO_S3_HOST) === null || _a === void 0 ? void 0 : _a.replace(/\/+$/, ''),
                accessKeyId: process.env.PICO_S3_ACCESS_KEY_ID,
                secretAccessKey: process.env.PICO_S3_SECRET_ACCESS_KEY,
            };
        }
        else {
            this.options = Object.assign(Object.assign({}, options), { host: (_b = options.host) === null || _b === void 0 ? void 0 : _b.replace(/\/+$/, '') });
        }
    }
    upload(options) {
    ...
    getPresignedUploadUrl(options) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield (0, api_1.getPresignedUploadUrl)(Object.assign(Object.assign({}, this.options), options));
        });
    }
}
